...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(20, 40, 105, 371));
        ...
        btn_copyLogs = new QPushButton(layoutWidget);
        ...
        btn_uploadLogs = new QPushButton(layoutWidget);
        ...
        btn_packFlash = new QPushButton(layoutWidget);
        ...
        btn_packDownload = new QPushButton(layoutWidget);
